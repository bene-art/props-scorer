...
├── data/                      # Gitignored — fetch with fetch_data.py
├── models/
│   └── xgb_scorer_v3.joblib  # Committed synthetic baseline; nba_points_v1.joblib generated by train_model.py
├── scripts/
...
├── tests/                 # 40 checks to prove it works
